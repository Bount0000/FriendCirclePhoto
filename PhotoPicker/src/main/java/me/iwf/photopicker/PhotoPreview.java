...
public class PhotoPreview {
  ...
  public final static String EXTRA_COMS       = "coms";
  public final static String EXTRA_TIMES       = "times";
  ...
  public static class PhotoPreviewBuilder {
    ...
    public PhotoPreviewBuilder setTimes(ArrayList<String> times) {
      mPreviewOptionsBundle.putStringArrayList(EXTRA_TIMES, times);
      return this;
    }

    public PhotoPreviewBuilder setComs(ArrayList<String> coms) {
      mPreviewOptionsBundle.putStringArrayList(EXTRA_COMS, coms);
      return this;
    }
