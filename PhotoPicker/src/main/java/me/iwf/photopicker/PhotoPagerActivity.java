...
import static me.iwf.photopicker.PhotoPreview.EXTRA_COMS;
...
import static me.iwf.photopicker.PhotoPreview.EXTRA_TIMES;
...
public class PhotoPagerActivity extends AppCompatActivity {
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    List<String> coms = getIntent().getStringArrayListExtra(EXTRA_COMS);
    List<String> times = getIntent().getStringArrayListExtra(EXTRA_TIMES);
    ...
    pagerFragment.setPhotos(paths, coms,times,currentItem);
