...
public class ImagePagerFragment extends Fragment {
  ...
  public void setPhotos(List<String> paths,List<String> coms,List<String> times, int currentItem) {
    this.paths.clear();
  ...
  @Override public void onCreate(Bundle savedInstanceState) {
    ...
    mPagerAdapter = new PhotoPagerAdapter(Glide.with(this), paths,times,coms);
  }
