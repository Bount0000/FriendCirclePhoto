...
//          startActivityForResult(intent, ImageCaptureManager.REQUEST_TAKE_PHOTO);
  ...
  @Override public void onActivityResult(int requestCode, int resultCode, Intent data) {
    ...
    Log.e("2",ImageCaptureManager.REQUEST_TAKE_PHOTO+"");
...
//      }
  ...
  private void openCamera(){
    ...
    PHOTO_FILE_NAME = "yydj"+ UUID.randomUUID().toString()+".jpg";
    intent.putExtra(MediaStore.EXTRA_OUTPUT, Uri.fromFile(new File(Environment.getExternalStorageDirectory(), PHOTO_FILE_NAME)));//
    startActivityForResult(intent, ImageCaptureManager.REQUEST_TAKE_PHOTO);// 请求照相机
  }
}
